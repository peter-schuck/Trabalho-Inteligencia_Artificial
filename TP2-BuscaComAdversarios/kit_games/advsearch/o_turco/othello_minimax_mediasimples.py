...
def make_move(state) -> Tuple[int, int]:
    ...
    return minimax_move(state, 5, evaluate_mediasimples)


def evaluate_mediasimples(state, player:str) -> float:
    """
    ...
    return (0.5 * num_legal_moves_advantage) + (0.5 * num_pieces_advantage)